  ...
  <div v-if="isShow" class="flex flex_ju_sb videos-page">
    ...
    <el-row :gutter="24">
      <el-col :xs="24" :sm="24" :lg="18">
        <div class="centers left_box card_box">
          <div class="top_box">
...
export default {
          ...
          videos: [
            {
              ...
              vurl: "//sf1-cdn-tos.huoshanstatic.com/obj/media-fe/xgplayer_doc_video/hls/xgplayer-demo.m3u8",
            ...
            },
            {
              ...
              vurl: "https://d2zihajmogu5jn.cloudfront.net/bipbop-advanced/bipbop_16x9_variant.m3u8",
            },
            {
              id: "3",
              vcode: "3",
  ...
  mounted() {
    // this.getStartPush();
    for (let index = 0; this.treeData[0].videos.length < 10; index++) {
      ...
      videoApi.getLiveList().then((response) => {
        if (response.data.length > 0) {
          ...
          const arr = response.data.map(item => {
            return {
              id: item.userId + item.sessionID,
              vcode: item.userId + item.sessionID,
              vname: item.hlsUrl,
              vurl: item.hlsUrl,
              // vurl: "//d2zihajmogu5jn.cloudfront.net/sintel/master.m3u8",
              // vurl: "//d2zihajmogu5jn.cloudfront.net/elephantsdream/hls/ed_hd.m3u8",
          ...
          this.treeData[0].videos = [...arr, ...this.treeData[0].videos]
          return
        }
      });
    },
